			...
			<div class="row justify-content-sm-center h-100">
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					<div class="text-center" style="margin-top: 35%">
						<img
							src="https://c.tenor.com/Gr2tQ0pdA_4AAAAd/jaguar-car-jaguar-ftype.gif"
							alt="logo" width="150" opacity="50%">
					</div>
					<div class="card img-fluid">
						<img class="card-img-top"
							src="https://w0.peakpx.com/wallpaper/12/182/HD-wallpaper-tyretread-cars-passion-rubber-sports-toyo-tread-tyre.jpg" height="500">
